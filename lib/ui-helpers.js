...
function changeFrequencyButton(frequencyPref, buttonText, active) {
  ...
  return {
    type: "button",
    action: `mem.${CHANGE_FREQ}.${frequencyPref.toString().replace(".", "-")}`, // replace decimal with - to not conflict with '.' in params
    text: buttonText || "&nbsp; &nbsp;",
...
function changeFrequencyButtonsWithChart() {
  return [
    ...
    {
      type: "html",
      text: getFrequencyIllustration(0.2)
    },
    {
      type: "button",
      action: "frequency.p2",
    ...
    {
      type: "html",
      text: getFrequencyIllustration(0.5)
    },
    {
      type: "button",
      action: "frequency.1",
    ...
    {
      type: "html",
      text: getFrequencyIllustration(1)
    },
    {
      type: "button",
      action: "frequency.3",
    ...
    {
      type: "html",
      text: getFrequencyIllustration(3)
    },
    {
      type: "button",
      action: "frequency.6",
    ...
    {
      type: "html",
      text: getFrequencyIllustration(6)
    },
    {
      type: "button",
      action: "frequency.12",
    ...
    {
      type: "html",
      text: getFrequencyIllustration(10)
    },
    {
      type: "button",
      action: "cancel",
