...
function changeFrequencyButton(
  ...
  return {
    ...
    body: `Your new memorization schedule will be: ${getFutureIntervalSentence(
      ...
      frequencyPref,
      nextReminderNum
    )}. <br /><br />Your next reminder will arrive on the first date of this new schedule.`
  };
}
...
function renderRepeatMessage(gopher) {
  ...
  const messageTable = {
    ...
    "2":
      "Were you able to remember? We will send 1 more reminders before turning off this memorization.<br /><br />--<br /><br />",
    "3":
